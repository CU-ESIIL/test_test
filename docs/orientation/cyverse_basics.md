...
1. From the Cyverse Discovery Environment, click on `Apps` in the left menu
   ...
   [Raw photo location: apps.svg](https://github.com/CU-ESIIL/test_test/blob/main/docs/assets/cyverse_basics/apps.svg)

2. Select `JupyterLab ESIIL`
   ![use_this_app](../assets/cyverse_basics/use_this_app.svg)
[Raw photo location: use_this_app.svg](https://github.com/CU-ESIIL/test_test/blob/main/docs/assets/cyverse_basics/use_this_app.svg)
...
[Raw photo location: app_launch.svg](https://github.com/CU-ESIIL/test_test/blob/main/docs/assets/cyverse_basics/app_launch.svg)

   ![app_settings](../assets/cyverse_basics/app_settings.svg)
[Raw photo location: app_settings.svg](https://github.com/CU-ESIIL/test_test/blob/main/docs/assets/cyverse_basics/app_settings.svg)

   ![launch](../assets/cyverse_basics/launch.svg)
[Raw photo location: launch.svg](https://github.com/CU-ESIIL/test_test/blob/main/docs/assets/cyverse_basics/launch.svg)

4. Click `Go to analysis`:
   ![go_to_analysis](../assets/cyverse_basics/go_to_analysis.svg)
[Raw photo location: go_to_analysis.svg](https://github.com/CU-ESIIL/test_test/blob/main/docs/assets/cyverse_basics/go_to_analysis.svg)

5. Now you should see Jupyter Lab!
   ![jupyterlab](../assets/cyverse_basics/jupyterlab.svg)
[Raw photo location: jupyterlab.svg](https://github.com/CU-ESIIL/test_test/blob/main/docs/assets/cyverse_basics/jupyterlab.svg)
...
[Raw photo location: clone.svg](https://github.com/CU-ESIIL/test_test/blob/main/docs/assets/cyverse_basics/clone.svg)
...
[Raw photo location: cyverse-utils.svg](https://github.com/CU-ESIIL/test_test/blob/main/docs/assets/cyverse_basics/cyverse-utils.svg)

4. Go into the `cyverse-utils` folder:
   ![click_cyverse_utils](../assets/cyverse_basics/click_cyverse_utils.svg)
[Raw photo location: click_cyverse_utils.svg](https://github.com/CU-ESIIL/test_test/blob/main/docs/assets/cyverse_basics/click_cyverse_utils.svg)
...
[Raw photo location: open_cyverse_utils.svg](https://github.com/CU-ESIIL/test_test/blob/main/docs/assets/cyverse_basics/open_cyverse_utils.svg)
...
[Raw photo location: script_1.svg](https://github.com/CU-ESIIL/test_test/blob/main/docs/assets/cyverse_basics/script_1.svg)

   ![username](../assets/cyverse_basics/username.svg)
[Raw photo location: username.svg](https://github.com/CU-ESIIL/test_test/blob/main/docs/assets/cyverse_basics/username.svg)

   ![email](../assets/cyverse_basics/email.svg)
[Raw photo location: email.svg](https://github.com/CU-ESIIL/test_test/blob/main/docs/assets/cyverse_basics/email.svg)
...
[Raw photo location: key.svg](https://github.com/CU-ESIIL/test_test/blob/main/docs/assets/cyverse_basics/key.svg)

8. Go to your GitHub settings page (you may need to log in to GitHub first):
   ![settings](../assets/cyverse_basics/settings.svg)
[Raw photo location: settings.svg](https://github.com/CU-ESIIL/test_test/blob/main/docs/assets/cyverse_basics/settings.svg)

9. Select `SSH and GPG keys`
   ![ssh](../assets/cyverse_basics/ssh.svg)
[Raw photo location: ssh.svg](https://github.com/CU-ESIIL/test_test/blob/main/docs/assets/cyverse_basics/ssh.svg)

10. Select `New SSH key`
   ![new_key](../assets/cyverse_basics/new_key.svg)
[Raw photo location: new_key.svg](https://github.com/CU-ESIIL/test_test/blob/main/docs/assets/cyverse_basics/new_key.svg)
...
[Raw photo location: paste_key.svg](https://github.com/CU-ESIIL/test_test/blob/main/docs/assets/cyverse_basics/paste_key.svg)
...
[Raw photo location: final.svg](https://github.com/CU-ESIIL/test_test/blob/main/docs/assets/cyverse_basics/final.svg)
